    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: '12px', color: '#888', display: 'flex', alignItems: 'center', gap: '6px' }}>
          Drag 
          <span className="move-cursor" style={{
...
// // === DRAGGABLE WINDOW COMPONENT (Updated with Resize & Visuals) ===
// const DraggableResult = ({ children, title, onClose }: { children: React.ReactNode, title: string, onClose: () => void }) => {
//   const [position, setPosition] = useState({ x: 0, y: 0 });
//   const [isDragging, setIsDragging] = useState(false);
//   const [dragOffset, setDragOffset] = useState({ x: 0, y: 0 });
...
//       <div 
//         onMouseDown={handleMouseDown}
//         // Swaps between Open Hand (Idle) and Closed Hand (Dragging)
//         className={isDragging ? 'grabbing-cursor' : 'grab-cursor'} 
//         style={{
//           padding: '15px',
//           background: '#f1f1f1',
...
//         {/* Visual Cue: Shows the "Four Arrow" icon next to text */}
//         <div style={{ fontSize: '12px', color: '#888', display: 'flex', alignItems: 'center', gap: '6px' }}>
//           Drag 
//           <span className="move-cursor" style={{
//             display: 'inline-block', width: '16px', height: '16px', 
...
//           width: '20px',
//           height: '20px',
//           // Forces the Resize Cursor (Diagonal Arrow)
//           cursor: 'url(/cursors/resize.png) 32 32, nwse-resize', 
//           zIndex: 10
//         }} 
//       />
//     </div>
...
const Game: React.FC<GameProps> = ({ onExit }) => {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: 'transparent' }}>
      ...
      {gameMode === 'GUESSING' && currentChallenge && (
        <div style={{ display: 'flex', width: '100%', height: '100%', padding: '60px 20px 20px 20px', boxSizing: 'border-box', gap: '20px' }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '15px' }}>
            ...
            >
              {/* 1. The Image */}
              <img src="/guess_button.png" alt="Guess" className="guess-btn-img" />
      ...
      {gameMode === 'GAME_OVER' && (
        <div style={{ 
          ...
          <div style={{ 
            ...
            <button
                onClick={onExit} // <--- CALLS THE EXIT FUNCTION
                style={{
                    padding: '15px 40px', background: '#f44336', color: 'white',
                    border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '20px', fontWeight: 'bold'
                }}
            >
                Exit
